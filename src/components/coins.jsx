...
export default function Coins() {
    ...
    return (
        <>
            <div className="coinsInfoContainer bg-mainBG w-full flex flex-col items-center ">
                <div className="coinInfo flex justify-between items-center w-full border-t-2 border-t-main">
                ...
                {AllowedToLoad ?
                    loading ?
                        <div className="w-full p-3 rounded-lg h-14 bg-secondary text-center capitalize text-xl cursor-not-allowed">one minute...</div>
                        : <button onClick={handleLoadMore} className="w-1/4 mt-6 text-main p-3 rounded-lg h-14 bg-secondary hover:bg-darkSecondary capitalize text-xl ">load more</button>
                    : <NavLink to={'/coins'} className="w-1/4 mt-10 p-3 h-14 bg-main text-secondary hover:bg-lightMain text-center capitalize text-xl">learn more</NavLink>}
            </div>
        </>
